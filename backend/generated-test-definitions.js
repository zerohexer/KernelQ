...
// Generated at: 2025-10-19T13:30:21.418Z
        ...
        },
        {
            ...
            "testScenario": {
                ...
                "testCommands": [
                    ...
                    "dmesg | grep 'Allocating.*devices' && echo 'PASS: Array allocation initiated' || echo 'FAIL: Array allocation broken'",
                    "dmesg | grep 'Successfully allocated.*devices' && echo 'PASS: Array allocation successful' || echo 'FAIL: Array allocation broken'",
                    ...
                    "dmesg | grep \"Allocating $COUNT1 devices\" && echo 'PASS: Correct device count allocation' || echo 'FAIL: Wrong device count'",
                    "dmesg | grep \"Successfully allocated $COUNT1 devices\" && echo 'PASS: All '$COUNT1' devices allocated' || echo 'FAIL: Allocation incomplete'",
                    ...
                    "dmesg | grep 'Freeing.*devices' && echo 'PASS: Cleanup initiated' || echo 'FAIL: Cleanup not initiated'",
        ...
        },
        {
            ...
            "testScenario": {
                ...
                "testCommands": [
                    ...
                    "dmesg | grep 'Allocating.*devices' && echo 'PASS: Level 1 allocation (device array) working' || echo 'FAIL: Level 1 allocation broken'",
                    "dmesg | grep 'Successfully allocated.*devices' && echo 'PASS: Two-level allocation successful' || echo 'FAIL: Two-level allocation broken'",
                    "echo 'Phase 5: Runtime Device Count Validation'",
                    "echo 'Validating with runtime count '$COUNT1' devices...'",
                    "dmesg | grep \"Runtime device count: $COUNT1\" && echo 'PASS: Runtime count '$COUNT1' detected' || echo 'FAIL: Runtime count detection broken'",
                    "dmesg | grep \"Allocating $COUNT1 devices\" && echo 'PASS: Correct device count allocation' || echo 'FAIL: Wrong device count'",
                    ...
                    "dmesg | grep 'Freeing.*devices' && echo 'PASS: Cleanup initiated' || echo 'FAIL: Cleanup not initiated'",
                    "dmesg | grep 'All devices freed' && echo 'PASS: Two-level cleanup (Level 2 then Level 1) successful' || echo 'FAIL: Cleanup broken'",
                    "dmesg | grep 'Module unloaded cleanly' && echo 'PASS: Complete cleanup successful' || echo 'FAIL: Module unload broken'",
                    "echo 'Phase 8: Final Validation Summary'",
                    "echo 'PASS: All runtime-determined allocation validation successful'"
                ],
                "expected": {
                    ...
                    "stdout": [
                        ...
                        "PASS: Device boolean field correct",
                        "PASS: Cleanup initiated",
                        "PASS: Two-level cleanup \\(Level 2 then Level 1\\) successful",
                        "PASS: Complete cleanup successful",
                        "PASS: All runtime-determined allocation validation successful"
                    ]
                },
