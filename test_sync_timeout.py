...
try:
    ...
    if execution_time > 58 and execution_time < 65:
        ...
        print(f"   ⚠️ Finished faster than expected - check if timeout sync working")
    else:
        print(f"   ⚠️ Took longer than 60s - includes compilation time")
...
print(f"   • '⏱️ Frontend timeout synced to: 60s (matching backend)'")
