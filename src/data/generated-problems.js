...
// Generated at: 2025-08-22T03:01:32.133Z
...
const problemBank = [
  ...
  },
  {
    ...
    "xp": 25,
    "phase": "foundations",
    "description": "PART A (OBSERVE): Study a complete working example with multiple data types. See how int, char, and bool variables work together with proper format specifiers. This example includes advanced module parameter support that will be used in later problems.",
    "concepts": [
      "multiple data types",
      "integer variables",
      "character variables",
  ...
  },
  {
    ...
    "xp": 35,
    "phase": "foundations",
    "description": "PART B (PRACTICE): Build on Problem 4 by completing a partially implemented solution. Fill in strategic gaps while working with module parameters for dynamic testing. This bridges complete examples to independent creation.",
    "concepts": [
      "guided practice",
      "multiple data types",
    ...
    "inputOutput": {
      ...
      "requirements": [
        ...
        "Print exact message format for backend validation compatibility",
        "Must include: linux/module.h, linux/kernel.h, linux/init.h, linux/types.h",
        "Code must contain: extern int employee_id, extern char performance_grade, extern bool is_promoted, int employee_id = 67890, char performance_grade = 'A', bool is_promoted = true",
        "Must include MODULE_LICENSE(\"GPL\")"
      ]
    }
  },
  {
    ...
    "inputOutput": {
      ...
      "requirements": [
        ...
        "Print exact message format for backend validation compatibility",
        "Must include: linux/module.h, linux/kernel.h, linux/init.h, linux/types.h",
        "Code must contain: extern int server_id, extern char status_code, extern int temperature, extern bool online, int server_id = 1001, char status_code = 'R', int temperature = 68, bool online = true, module_param(server_id, int, 0644), module_param(temperature, int, 0644)",
        "Must include MODULE_LICENSE(\"GPL\")"
      ]
    }
  },
        ...
        },
        {
          ...
          "testScenario": {
            ...
            "testCommands": [
              ...
              "echo 'Phase 3: Context-Aware Conditional Logic Validation'",
              "echo 'Validating positive number logic (99 should be positive)'",
              "dmesg | grep 'Number 99 is positive' && echo 'PASS: Positive number logic correct' || { echo 'FAIL: Positive number logic wrong'; exit 1; }",
              "echo 'Validating negative number logic (-88 should be negative)'",
              "dmesg | grep 'Number -88 is negative' && echo 'PASS: Negative number logic correct' || { echo 'FAIL: Negative number logic wrong'; exit 1; }",
              "echo 'Validating zero logic (0 should be zero)'",
              "dmesg | grep 'Number 0 is zero' && echo 'PASS: Zero logic correct' || { echo 'FAIL: Zero logic wrong'; exit 1; }",
              "echo 'Phase 4: Cross-Validation Consistency Check'",
              "echo 'Checking that specific test values produced correct results'",
              ...
              "echo 'Test 99 positive results: '$TEST_99_POSITIVE' (expected: 1)'",
              "echo 'Test -88 negative results: '$TEST_88_NEGATIVE' (expected: 1)'",
              "echo 'Test 0 zero results: '$TEST_0_ZERO' (expected: at least 1)'",
              "if [ $TEST_99_POSITIVE -eq 1 ] && [ $TEST_88_NEGATIVE -eq 1 ] && [ $TEST_0_ZERO -ge 1 ]; then echo 'PASS: All conditional logic working correctly'; else echo 'FAIL: Conditional logic validation failed - Test 99: '$TEST_99_POSITIVE', Test -88: '$TEST_88_NEGATIVE', Test 0: '$TEST_0_ZERO; exit 1; fi"
            ],
            "expected": {
              "dmesg": [
                "Conditional logic module loaded",
  ...
  {
    "id": 9,
    "title": "Basic Loops - Repetition and Iteration",
    "difficulty": 3,
    "xp": 35,
    "phase": "foundations",
    "description": "Learn to use loops for repetitive tasks and calculations. This introduces iteration patterns commonly used in kernel development for processing data, managing resources, and implementing algorithms.",
    "concepts": [
      "for loops",
      "loop variables",
      "iteration patterns",
    ...
    "validation": {
      ...
      "testCases": [
        ...
        {
          "id": "for_loop_structure",
          "name": "Proper For Loop Structure",
          "type": "code_analysis",
          "critical": true,
          "expectedSymbols": [
            "for.*i.*=.*1.*i.*<=.*count.*i\\+\\+",
        ...
        {
          "id": "loop_calculations",
          "name": "Loop-based Calculations",
          "type": "code_analysis",
          "critical": true,
          "expectedSymbols": [
            "sum.*\\+=.*i",
  ...
  {
    "id": 10,
    "title": "Arrays and Collections - Managing Multiple Values",
    "difficulty": 4,
    "xp": 40,
    "phase": "foundations",
    "description": "Learn to work with arrays to store and manage multiple values. This introduces data collection patterns essential for kernel development where you often need to manage lists of devices, buffers, or other resources.",
    "concepts": [
      "array declaration",
      ...
      "testCases": [
        {
          ...
          "name": "Array Declaration in Header",
          "type": "code_analysis",
          "critical": true,
          "expectedSymbols": [
            "extern int student_grades\\[MAX_GRADES\\]",
        ...
        },
        {
          ...
          "name": "Array Initialization in Source",
          "type": "code_analysis",
          "critical": true,
          "expectedSymbols": [
            "int student_grades\\[MAX_GRADES\\].*=.*\\{85.*92.*78.*96.*88\\}"
        ...
        {
          "id": "array_iteration",
          "name": "Proper Array Iteration with Loops",
          "type": "code_analysis",
          "critical": true,
          "expectedSymbols": [
            "for.*i.*<.*grade_count.*i\\+\\+",
        ...
        {
          "id": "array_algorithms",
          "name": "Array Processing Algorithms",
          "type": "code_analysis",
          "critical": true,
          "expectedSymbols": [
  ...
  {
    "id": 11,
    "title": "String Handling - Working with Text in Kernel",
    "difficulty": 4,
    "xp": 40,
    "phase": "foundations",
    ...
    "skills": [
      ...
      "Text processing in kernel space"
    ],
    "files": [
      {
        "name": "strings.h",
      ...
      {
        "name": "strings.c",
        "content": "#include \"strings.h\"\n\n/* TODO: Initialize strings */\n/* char device_name[MAX_NAME_LEN] = \"my_device\"; */\n/* char welcome_message[MAX_MESSAGE_LEN] = \"Welcome to kernel string handling!\"; */\nint name_length = 0;\n\n/* TODO: Implement function to print device information */\n/* void print_device_info(void) {\n *     printk(KERN_INFO \"Device Name: %s\\n\", device_name);\n *     printk(KERN_INFO \"Name Length: %d\\n\", name_length);\n *     printk(KERN_INFO \"Message: %s\\n\", welcome_message);\n * } */\n\n/* TODO: Implement function to get string length manually */\n/* int get_string_length(const char *str) {\n *     int len = 0;\n *     while (str[len] != '\\0') {\n *         len++;\n *     }\n *     return len;\n * } */\n\n/* TODO: Implement function to copy device name safely */\n/* void copy_device_name(const char *new_name) {\n *     int i;\n *     for (i = 0; i < MAX_NAME_LEN - 1 && new_name[i] != '\\0'; i++) {\n *         device_name[i] = new_name[i];\n *     }\n *     device_name[i] = '\\0';\n *     name_length = get_string_length(device_name);\n * } */\n\nstatic int __init strings_init(void)\n{\n    printk(KERN_INFO \"String handling module loaded\\n\");\n    \n    /* TODO: Calculate initial name length */\n    /* name_length = get_string_length(device_name); */\n    \n    /* TODO: Print initial device info */\n    /* print_device_info(); */\n    \n    /* TODO: Copy new device name and print again */\n    /* copy_device_name(\"updated_device\"); */\n    /* printk(KERN_INFO \"After name change:\\n\"); */\n    /* print_device_info(); */\n    \n    return 0;\n}\n\nstatic void __exit strings_exit(void)\n{\n    printk(KERN_INFO \"String handling module unloaded\\n\");\n}\n\nmodule_init(strings_init);\nmodule_exit(strings_exit);\n\nMODULE_LICENSE(\"GPL\");\nMODULE_AUTHOR(\"Student\");\nMODULE_DESCRIPTION(\"Learning string handling in kernel space\");\nMODULE_VERSION(\"1.0\");",
        "readOnly": false,
        "language": "c"
      },
      {
    ...
    "inputOutput": {
      ...
      "requirements": [
        "Use required function names: strings_init, strings_exit, print_device_info, get_string_length, copy_device_name",
        "Use required variable names: device_name, welcome_message, name_length",
        "Print exact message format for backend validation compatibility",
        "Must include: linux/module.h, linux/kernel.h, linux/init.h, linux/types.h, linux/string.h",
        "Code must contain: #define MAX_NAME_LEN 32, #define MAX_MESSAGE_LEN 64, extern char device_name[MAX_NAME_LEN], extern char welcome_message[MAX_MESSAGE_LEN], char device_name[MAX_NAME_LEN] = \"my_device\", char welcome_message[MAX_MESSAGE_LEN] = \"Welcome to kernel string handling!\"",
        "Must include MODULE_LICENSE(\"GPL\")"
      ]
    }
  },
