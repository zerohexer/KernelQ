...
// Generated at: 2025-09-01T19:14:10.586Z
...
const problemBank = [
  ...
  },
  {
      ...
      "testCases": [
        ...
        },
        {
          ...
          "expected": [
            ...
            {
              "pattern": "Why dynamic allocation? Because users can configure devices at runtime!",
              "exact": true,
              "linkedFunction": "static int __init dynamic_memory_init(void)"
            },
            {
              "pattern": "Creating primary device with ID=1001, Name=primary_sensor",
              "exact": true,
              "linkedFunction": "int create_primary_device(int id, const char *name)"
            },
            {
              "pattern": "Primary device allocated successfully!",
              "exact": true,
              "linkedFunction": "int create_primary_device(int id, const char *name)"
            },
            {
              "pattern": "=== Primary Device Info ===",
              "exact": true,
              "linkedFunction": "void print_device_info(Device *dev, const char *label)"
            },
            {
              "pattern": "Device ID: 1001",
              "exact": true,
            ...
            {
              "pattern": "Device Name: primary_sensor",
              "exact": true,
              "linkedFunction": "void print_device_info(Device *dev, const char *label)"
            },
            {
            ...
            {
              "pattern": "Creating backup device with ID=2001, Name=backup_sensor",
              "exact": true,
              "linkedFunction": "int create_backup_device(int id, const char *name)"
            },
            {
              "pattern": "Backup device allocated successfully!",
              "exact": true,
              "linkedFunction": "int create_backup_device(int id, const char *name)"
            },
            {
              "pattern": "=== Backup Device Info ===",
              "exact": true,
              "linkedFunction": "void print_device_info(Device *dev, const char *label)"
            },
            {
            ...
            {
              "pattern": "Device Name: backup_sensor",
              "exact": true,
              "linkedFunction": "void print_device_info(Device *dev, const char *label)"
            },
            {
            ...
            {
              "pattern": "Status: STANDBY",
              "exact": true,
              "linkedFunction": "void print_device_info(Device *dev, const char *label)"
            },
            {
              "pattern": "Total devices created: 2",
              "exact": true,
              "linkedFunction": "static int __init dynamic_memory_init(void)"
            },
            {
              "pattern": "This demonstrates why dynamic allocation is powerful!",
              "exact": true,
              "linkedFunction": "static int __init dynamic_memory_init(void)"
            },
            {
            ...
            {
              "pattern": "WHY cleanup? Because we must return borrowed memory to the kernel!",
              "exact": true,
              "linkedFunction": "static void __exit dynamic_memory_exit(void)"
            },
            {
              "pattern": "Primary device freed",
              "exact": true,
              "linkedFunction": "void cleanup_devices(void)"
            },
            {
              "pattern": "Backup device freed",
              "exact": true,
              "linkedFunction": "void cleanup_devices(void)"
            },
            {
              "pattern": "All memory returned to kernel. Module unloaded cleanly.",
              "exact": true,
              "linkedFunction": "static void __exit dynamic_memory_exit(void)"
            }
          ]
    ...
    "inputOutput": {
      ...
      "requirements": [
        "Use required function names: dynamic_memory_init, dynamic_memory_exit, create_primary_device, create_backup_device, print_device_info, cleanup_devices",
        "Use required variable names: primary_device, backup_device, device_count",
        "Print exact message format for backend validation compatibility",
        "Must include: linux/module.h, linux/kernel.h, linux/init.h, linux/types.h, linux/slab.h, linux/string.h",
        "Code must contain: kmalloc(sizeof(Device), GFP_KERNEL), kfree(primary_device), kfree(backup_device), if (!primary_device), if (!backup_device), return -ENOMEM, primary_device = NULL, backup_device = NULL, module_param(primary_id, int, 0644), module_param(backup_id, int, 0644), module_param(enable_backup, int, 0644)",
        "Must include MODULE_LICENSE(\"GPL\")"
      ],
      "functionLinkedOutputs": [
        {
