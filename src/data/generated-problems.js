...
// Generated at: 2025-10-13T16:23:51.517Z
    ...
    "validation": {
      "exactRequirements": {
        ...
        "function_declarations": [
          ...
          {
            "name": "detect_driver_by_code",
            "returnType": "enum driver_type",
            "parameters": [
              "uint16_t type_code"
            ]
          },
          {
            "name": "count_drivers_by_flag",
            "returnType": "int",
            "parameters": [
              "uint32_t flag"
            ]
      ...
      "testCases": [
        ...
        },
        {
          ...
          "expected": [
            ...
            {
              "pattern": "Initializing USB Serial driver",
              "exact": true,
            ...
            {
              "pattern": "Cleaning up USB Serial driver",
              "exact": true,
