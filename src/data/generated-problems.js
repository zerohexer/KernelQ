...
// Generated at: 2025-08-18T18:13:15.744Z
      ...
      "testCases": [
        ...
        },
        {
          ...
          "testScenario": {
            ...
            "setupCommands": [
              "echo 'Starting advanced function parameter testing'"
            ],
            "testCommands": [
              "/bin/function_tester",
              "echo 'Checking function outputs for all test values'",
              "dmesg | grep '10 + 30 = 40' && echo 'PASS: add_numbers(10,30) worked' || echo 'FAIL: add_numbers test failed'",
              "dmesg | grep 'Sum is even: 1' && echo 'PASS: is_even(40) worked' || echo 'FAIL: is_even even test failed'",
              "dmesg | grep '7 + 8 = 15' && echo 'PASS: add_numbers(7,8) worked' || echo 'FAIL: add_numbers test failed'",
              "dmesg | grep 'Sum is even: 0' && echo 'PASS: is_even(15) worked' || echo 'FAIL: is_even odd test failed'"
            ],
            "expected": {
              "dmesg": [
                "Function parameters module loaded",
              ...
              "stdout": [
                ...
                "SUCCESS: Dynamic test completed",
                "PASS: Function parameters detected",
                "PASS: Module parameters work"
              ]
            },
            "timeout": 45
  ...
  },
  {
    ...
    "inputOutput": {
      ...
      "requirements": [
        ...
        "Print exact message format for backend validation compatibility",
        "Must include: linux/module.h, linux/kernel.h, linux/init.h, linux/types.h",
        "Code must contain: extern int test_number, int test_number = 42, void check_number_status(int number), if (number > 0), else if (number < 0), else",
        "Must include MODULE_LICENSE(\"GPL\")"
      ]
    }
  },
