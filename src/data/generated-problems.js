...
// Generated at: 2025-07-19T14:53:24.013Z
  ...
  },
  {
    ...
    "inputOutput": {
      ...
      "requirements": [
        ...
        "Code must contain: printk, KERN_INFO, extern, extern int my_int, extern char my_char, extern bool my_bool",
        "Must include MODULE_LICENSE(\"GPL\")",
  ...
  },
  {
    ...
    "inputOutput": {
      ...
      "requirements": [
        ...
        "Print exact message format for backend validation compatibility",
        "Must include: linux/module.h, linux/kernel.h, linux/init.h",
        "Code must contain: for, printk, extern, #define ARRAY_SIZE, extern int numbers, void print_array",
        "Must include MODULE_LICENSE(\"GPL\")",
  ...
  },
  {
    ...
    "inputOutput": {
      ...
      "requirements": [
        ...
        "Print exact message format for backend validation compatibility",
        "Must include: linux/module.h, linux/kernel.h, linux/init.h",
        "Code must contain: int *x, int *y, &num1, &num2, return a + b, int add_numbers, void swap_values, void print_result",
        "Must include MODULE_LICENSE(\"GPL\")",
