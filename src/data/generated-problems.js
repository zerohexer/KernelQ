...
// Generated at: 2025-09-17T13:45:14.998Z
...
const problemBank = [
  ...
  },
  {
    ...
    "inputOutput": {
      ...
      "requirements": [
        "Use required function names: binary_parser_init, binary_parser_exit, read_uint32_from_buffer, read_uint16_from_buffer, read_string_from_buffer, parse_sensor_record, print_parsed_record",
        "Use required variable names: parsed_sensor, test_buffer",
        "Print exact message format for backend validation compatibility",
        "Must include: linux/module.h, linux/kernel.h, linux/init.h, linux/types.h, linux/slab.h",
        "Code must contain: *(uint32_t*)*buffer_ptr, *buffer_ptr += 4, *(uint16_t*)*buffer_ptr, *buffer_ptr += 2, kmalloc, kfree, read_uint32_from_buffer(&buffer_pos), read_uint16_from_buffer(&buffer_pos), read_string_from_buffer(&buffer_pos, module_param(test_sensor_id, int, 0644), module_param(test_measurement, int, 0644)",
        "Must include MODULE_LICENSE(\"GPL\")"
      ],
      "functionLinkedOutputs": [
        {
