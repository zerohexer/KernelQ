...
// Generated at: 2025-10-22T00:40:47.534Z
...
const problemBank = [
  ...
  },
  {
    ...
    "inputOutput": {
      ...
      "requirements": [
        "Use required function names: function_dispatch_init, function_dispatch_exit, register_event_handler, dispatch_event, show_registered_handlers, sensor_event_handler, motor_event_handler, status_event_handler, network_event_handler, storage_event_handler",
        "Use required variable names: event_ops_table, registered_handler_count",
        "Print exact message format for backend validation compatibility",
        "Must include: linux/module.h, linux/kernel.h, linux/init.h, linux/types.h",
        "Code must contain: event_ops_table[event_type].handler = handler, event_ops_table[event_type].handler(event_type, data, size), if (event_ops_table[event_type].handler == NULL), event_ops_table[event_type].event_count++, registered_handler_count++, module_param_array(register_handler_types, int, NULL, 0644), module_param_array(test_dispatch_types, int",
        "Must include MODULE_LICENSE(\"GPL\")"
      ],
      "functionLinkedOutputs": [
        {
